...
import com.zaryx.okaso.bukkit.nms.enchants.custom.CustomEnchantmentListener;
import com.zaryx.okaso.bukkit.nms.enchants.custom.CustomEnchantment;
import com.zaryx.okaso.bukkit.nms.enchants.custom.CustomEnchantmentHelper;
...
public final class CustomEnchantmentsAPI {
    ...
    public static void registerRuntimeListener() {
        Plugin plugin = OkasoPlugin.getInstance();
