...
import com.zaryx.okaso.bukkit.adapter.tablist.extra.TabEntry;
import com.zaryx.okaso.bukkit.adapter.tablist.extra.TabPacket;
...
public class TabManager {
    ...
    public TabManager(TabAdapter adapter) {
        ...
        Bukkit.getPluginManager().registerEvents(new TabHandler(), com.zaryx.okaso.bukkit.OkasoPlugin.getInstance());
    }
